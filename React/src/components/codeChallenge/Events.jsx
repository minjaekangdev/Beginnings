              ...
              >
                <div className="col-6">
                  <iframe
                    title="googleMaps"
                    id="googleMaps"
                    src={`https://www.google.com/maps/embed/v1/place?key=AIzaSyBcdVYMRHRSkQ-KkFwFuBIcEMSqNQBUErw&q=${mainEvent.metaData.location.address} ${mainEvent.metaData.location.zipCode}`}
